<h2><a href="https://www.geeksforgeeks.org/problems/largest-subarray-of-0s-and-1s/1?page=1&company=Morgan%20Stanley&difficulty=Easy&sortBy=latest">Largest subarray of 0's and 1's</a></h2><h3>Difficulty Level : Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size:18px">Given an array of 0s and 1s. Find the length of the largest subarray with equal number of 0s and 1s.</span></p>
